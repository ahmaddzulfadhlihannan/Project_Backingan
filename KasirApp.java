...
public class KasirApp {
    public static void main(String[] args) {
        ...
        int menu, menuMembership, menuLaporan, menuBooking, maxMembership = 12, maxBookingPerHari = 30;;
            ...
            do {
                ...
                switch (menu) {
                    ...
                    do{
                        ...
                        System.out.println("2. Daftar antrean");
                        System.out.println("0. Keluar");
                        ...
                        switch (menuBooking) {
                            case 1:
                                do{
                                    System.out.println("Menu");
                                    System.out.println("1. Pendaftaran booking");
                                    System.out.println("2. Tandai kustomer");
                                    System.out.println("0. Keluar");
                                    int menuBooking1 = sc.nextInt();

                                    switch (menuBooking1) {
                                        case 1:
                                            System.out.println("Masukkan nama :");
                                            namaBooking[p] = sc.next();
                                            System.out.println("Jam janjian");
                                            jamBooking[p] = sc.next();
                                            break;
                                        case 2:
